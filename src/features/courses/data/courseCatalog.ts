...
export const COURSE_CATALOG: Course[] = [
  ...
  },
  {
    ...
    details: [
      "The course centers around rifle/ammo performance validation, chronograph data collection, ballistic profiling, environmental effects, optic capability, trajectory confirmation, and practical application of ballistic data.",
      "Students will leave with a verified ballistic profile, confirmed trajectory data, validated holds, improved understanding of their optic system, and a greater understanding of the practical capabilities and limitations of their rifle setup. Regardless of whether a student runs a red dot, LPVO, BDC optic, MIL tree reticle, prism optic, or magnified precision setup — the goal is the same: understand the rifle system completely, then validate it through performance.",
      "Rifle System Analysis — validate rifle configuration, ammunition consistency, optic capability, ballistic performance, environmental effects, and shooter-to-rifle compatibility",
      "Ballistic Data Collection — chronograph ammunition, measure velocity consistency, build ballistic profiles, validate trajectory, calculate holds, and confirm real-world impacts at distance",
      "Applied Ballistics Integration — install the Applied Ballistics app prior to class; input rifle/ammo data, build ballistic profiles, verify environmental inputs, and validate ballistic predictions",
      "Optic-Specific Instruction — instruction adapts to your optic (red dot, LPVO, BDC, MIL tree, MOA, hybrid): mechanical offset, holdovers, speed drop numbers, wind holds, reticle usage, and trajectory validation",
      "Environmental Validation — re-chronograph throughout the day to observe temperature-related velocity shifts, density altitude, velocity variance, and real-world ballistic deviations",
      "Curriculum Phases — (1) Rifle System Evaluation, (2) Chronograph & Velocity Analysis, (3) Ballistic Profile Development, (4) Zero & Trajectory Validation, (5) Reticle Utilization, (6) Wind & Speed Drop, (7) Environmental Revalidation",
      "Required Student Information Sheet (complete prior to arrival): Rifle (manufacturer/model, caliber, barrel length, twist rate, suppressor use), Ammunition (manufacturer, load, grain, lot number), Optic (manufacturer/model, type, mount height, turret values, MIL/MOA, reticle type, FFP/SFP, subtensions, magnification), Red Dot specifics (dot size, mount height, magnifier info)",
      "American Rifleman I is designed to eliminate guesswork. The objective is not simply accuracy — it is confidence through validated data.",
    ],
    requirements: [
      "Functional semi-automatic rifle with properly mounted optic and confirmed mechanical reliability",
      "Recommended calibers: 5.56/.223, .308/7.62 NATO, 6 ARC, 6.5 Grendel, or similar rifle calibers",
      "Minimum 500 rounds — same manufacturer, same lot number, same grain weight, and same load throughout class (consistency is mandatory for accurate ballistic validation; mixed ammo strongly discouraged)",
      "Applied Ballistics Mobile App installed (free version acceptable)",
      "Phone fully charged with charging capability and basic app familiarity",
      "Completed Student Information Sheet (rifle, ammo, and optic details)",
      "Rifle sling",
      "At least 3 rifle magazines and magazine holders",
